    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <p>
              Dogs are domesticated mammals, part of the family Canidae. They are descendants of wolves and have been bred by humans for thousands of years. Known for their loyalty, companionship, and diverse roles in human society, dogs are often referred to as "man's best friend."
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <ul className="list-disc pl-6">
              <li>Loyal and affectionate towards their owners</li>
              ...
              <li>Can perform various tasks, from companionship to working roles</li>
            </ul>
          </CardContent>
        </Card>
